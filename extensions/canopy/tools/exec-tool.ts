...
export function registerExecTool(pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    promptSnippet: "Run allowlisted build and test commands in the Canopy worktree",
    promptGuidelines: ["Use canopy_exec instead of mutating bash commands during an active Canopy stage."],
