...
export function registerContextTool(pi: ExtensionAPI): void {
  pi.registerTool({
    name: "canopy_context",
    label: "Canopy Specialist Context",
    description: "Select a bounded, stage- and surface-specific set of Canopy specialist references without loading unrelated context.",
    promptSnippet: "Select bounded specialist iOS references before complex implementation or review",
    promptGuidelines: ["Use canopy_context before loading specialist references for SwiftUI, SwiftData, concurrency, testing, accessibility, privacy, monetization, release, widgets, or App Intents work; read only the returned paths that apply."],
