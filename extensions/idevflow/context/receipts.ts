...
function directory(repository: RepositoryDescriptor): string { return join(repository.primaryRoot, ".idevflow", "receipts", "context"); }
...
function lockPath(repository: RepositoryDescriptor): string { return join(repository.primaryRoot, ".idevflow", "state", "locks", "context-receipts.lock"); }
