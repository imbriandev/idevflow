...
export function registerExecTool(pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    promptSnippet: "Run allowlisted build and test commands in the iDevFlow worktree",
    promptGuidelines: ["Use idev_exec instead of mutating bash commands during an active iDevFlow stage."],
