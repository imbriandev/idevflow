...
function directory(repository: RepositoryDescriptor): string { return join(repository.primaryRoot, ".pi-ios", "receipts", "context"); }
...
function lockPath(repository: RepositoryDescriptor): string { return join(repository.primaryRoot, ".pi-ios", "state", "locks", "context-receipts.lock"); }
