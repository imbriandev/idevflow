...
export function registerSimulatorTool(pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    label: "Pi iOS Simulator",
    description: "Inspect, acquire, boot, or release the exclusive simulator lease for the current Pi iOS writer session.",
    ...
    async execute(_id, params, _signal, _update, ctx) {
      ...
      if (!session) throw new SafetyKernelError("Simulator operations require a Pi iOS writer session");
