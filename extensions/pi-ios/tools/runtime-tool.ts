...
export function registerRuntimeTool(pi: ExtensionAPI): void {
  pi.registerTool({
    ...
    description: "Inspect or initialize the deterministic Pi iOS project runtime. Initialization creates local .pi-ios state but does not modify product source.",
