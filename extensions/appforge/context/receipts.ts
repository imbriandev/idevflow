...
function directory(repository: RepositoryDescriptor): string { return join(repository.primaryRoot, ".appforge", "receipts", "context"); }
...
function lockPath(repository: RepositoryDescriptor): string { return join(repository.primaryRoot, ".appforge", "state", "locks", "context-receipts.lock"); }
