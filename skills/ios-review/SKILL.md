---
name: ios-review
description: Review a recent iOS change or beta candidate for product quality, SwiftUI design, accessibility, interface copy, Swift correctness, concurrency, persistence, privacy, and performance with evidence-linked severity.
