...
- `pi_ios_simulator screenshot` captures source-bound screenshot proof.
- `pi_ios_proof` prepares source-bound accessibility or performance metadata.
...
51 tests
50 normal-pass
1 Xcode E2E skipped unless PI_IOS_XCODE_E2E=1
```
